  ...
  return (
    <div className="h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex flex-col md:flex-row overflow-hidden">
          ...
          {loading ? (
            ...
            chats.map((chat) => (
              <div
                ...
                className={`px-4 py-2.5 rounded-2xl cursor-pointer mb-2 transition-all ${
      ...
      <div className="flex-1 flex flex-col h-full min-h-0">
        ...
        {/* Input Area */}
        <div className="bg-white/80 backdrop-blur-lg border-t border-white/20 p-4 md:p-6 flex-shrink-0">
