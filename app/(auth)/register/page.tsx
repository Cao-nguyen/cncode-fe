...
import { RegisterService } from "@/hooks/register-service"
            ...
            <div className="w-[80%] md:w-[50%] lg:w-[35%] xl:w-[30%] border border-[#e5e7eb]/20 rounded-xl">
                <div className="p-[15px_20px]">
                    ...
                    <div className="mt-[20px]">
                        ...
                        <ButtonAuth onClick={handleRegister} disabled={loading} className="bg-[#3b82f6] text-white">
                            {loading ? <p className="flex justify-center items-center gap-3"><Spinner /> Đang xử lí</p> : "Đăng ký"}
                        </ButtonAuth>
                        ...
                        <p className="text-white mt-[10px] text-[12px] text-center">
                            Bằng việc bạn tiếp tục đăng ký tài khoản đồng nghĩa với việc bạn đồng ý với
                            <Link className="text-[#6aa3ff]" href="/dieukhoansudung"> điều khoản sử dụng </Link>
                            của chúng tôi
                        </p>
