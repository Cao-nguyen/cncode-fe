...
function AdminUsersPageContent() {
    ...
    return (
        ...
        >
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
                ...
                {loadingProvince ? (
                    ...
                    <>
                        ...
                        <div className="admin-scroll-x mt-6 max-h-[400px] overflow-y-auto">
            ...
            {/* Tabs */}
            <div className="-mx-3 flex gap-1 overflow-x-auto border-b border-gray-200 px-3 pb-px sm:mx-0 sm:gap-2 sm:px-0">
                <button
                    onClick={() => {
                        setActiveTab('all');
                        setPage(1);
                    }}
                    className={`shrink-0 whitespace-nowrap px-3 py-2 text-sm font-medium transition sm:px-4 ${activeTab === 'all' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'}`}
                >
                ...
                <button
                    ...
                    className={`shrink-0 whitespace-nowrap px-3 py-2 text-sm font-medium transition flex items-center gap-1 sm:px-4 ${activeTab === 'pending' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'}`}
                >
                    Giáo viên chờ duyệt
