...
export default function AdminSendMailPage() {
    ...
    return (
        <div className="space-y-6 pb-8 px-3 sm:px-4">
            <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Gửi Email hàng loạt</h1>
                <p className="text-sm text-gray-500 mt-1">Thông báo đến {totalUsers.toLocaleString()} người dùng hệ thống</p>
            </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex gap-4">
                                <CustomButton
                                    ...
                                    className="w-full rounded-2xl shadow-lg shadow-blue-200"
                                >
