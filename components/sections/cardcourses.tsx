...
export default function CardCourses({
    ...
    return (
        <div className="w-full rounded-2xl border border-[#e6e6e6] dark:border-[#222222] bg-white dark:bg-[#171717] text-black dark:text-white overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-4 flex flex-col gap-2">
                ...
                <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 line-clamp-3">{description}</p>
