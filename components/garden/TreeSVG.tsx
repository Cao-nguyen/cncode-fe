    ...
    return (
        <div className="relative flex items-center justify-center min-h-[350px]">
            ...
            <svg width="300" height="350" viewBox="0 0 200 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    {/* Thân cây: Gradient gỗ tự nhiên thẫm */}
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {/* STAGE 3: ĐẠI THỤ NGHỆ THUẬT */}
                        {stage >= 3 && (
                            <g transform="translate(100, 215)">
                                {/* Thân chính to khỏe, uốn nhẹ */}
                                ...
                                {/* Tán lá tầng cao (Sáng) - Vẽ các đường nhấp nhô */}
                                ...
                                {/* Những điểm sáng li ti (như đom đóm hoặc nhụy hoa) */}
            ...
            {/* UI Progress bên dưới: Tối giản & Sang trọng */}
